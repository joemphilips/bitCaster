...
export type LocalWalletPaymentResult = { accepted: true } | { accepted: false; error?: string };
  ...
  const handlePay = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        await markPendingLocalWalletPaymentAcceptedButNotCompleted(pendingPaymentId, err).catch(
          () => undefined,
        );
    ...
    <>
      ...
      {topUpStage === "modal" && (
        <InsufficientBalanceModal
          ...
          requiredDescription={
            topUpRequiredDescription ?? t("marketCreation.depositWalletTopUpRequiredDescription")
          }
