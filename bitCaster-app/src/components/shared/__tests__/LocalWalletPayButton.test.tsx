...
vi.mock('@/lib/pendingLocalWalletPayments', () => ({
  ...
  markPendingLocalWalletPaymentAccepted: (...args: unknown[]) => markPendingLocalWalletPaymentAccepted(...args),
  completePendingLocalWalletPayment: (...args: unknown[]) => completePendingLocalWalletPayment(...args),
...
describe('LocalWalletPayButton', () => {
  beforeEach(async () => {
    ...
    selectAndReserveUnitProofs.mockResolvedValue([
      { id: 'keyset-sat', amount: 150, secret: 'proof-a', C: 'C-a', mintUrl: activeMintUrl, baseAsset: 'sat', unit: 'sat' },
    ])
  ...
  it('encodes the local-wallet payment token with the selected collateral unit', async () => {
    ...
    selectAndReserveUnitProofs.mockResolvedValueOnce([
      { id: 'keyset-msat', amount: 150_000, secret: 'proof-msat', C: 'C-msat', mintUrl: activeMintUrl, baseAsset: 'sat', unit: 'msat' },
    ])
