...
const TEST_NSEC_HEX = "1111111111111111111111111111111111111111111111111111111111111111";
...
describe("buildOracleAttestationEvent", () => {
  ...
  it("rejects malformed attestation hex", () => {
    expect(() => buildOracleAttestationEvent(TEST_NSEC_HEX, "", ANNOUNCEMENT_EVENT_ID)).toThrow(
      /hex/i,
    );
    expect(() => buildOracleAttestationEvent(TEST_NSEC_HEX, "xyz", ANNOUNCEMENT_EVENT_ID)).toThrow(
      /hex/i,
    );
    expect(() => buildOracleAttestationEvent(TEST_NSEC_HEX, "abc", ANNOUNCEMENT_EVENT_ID)).toThrow(
      /hex/i,
    );
  });
