...
import {
  ...
  type CtfSplitRequest,
  type CtfSplitResponse,
...
import { CheckStateEnum, OutputData, type ProofState, type SwapPreview } from '@cashu/cashu-ts'
...
class FakeSplitTransport implements CtfSplitTransport {
  readonly posted: CtfSplitRequest[] = []

  async getKeys(keysetId: string): Promise<MintKeys> {
    return { id: keysetId, unit: 'sat', keys: {}, input_fee_ppk: 0 } as MintKeys
  }
