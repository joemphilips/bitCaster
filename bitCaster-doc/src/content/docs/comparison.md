...
- **Open specs** — bitCaster is built on open protocols ([Conditional Token Framework](./user-guide/core-concepts/conditional-tokens/), Nostr kind 88, DLC). Predyx uses a proprietary system.
